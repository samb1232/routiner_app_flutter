...
class DatabaseHelper {
  ...
  // TODO: Сделать функции для таблицы dayStreakedInfo.

  /* При нажатии кнопки Finish в процессе выполнения рутины, в бд в таблице
  *  заполняется значение.
  *  Кнопка "Start" становится disabled если в табилце dayStreakedInfo
  *  рутина уже выполнена.
  */
